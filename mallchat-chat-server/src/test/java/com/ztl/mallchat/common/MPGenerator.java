...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.ztl.mallchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("2002");
        dataSourceConfig.setUrl("jdbc:mysql://1.12.237.122:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
